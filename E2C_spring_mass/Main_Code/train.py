...
def main(args):
    env_name = args.env
    assert env_name in ['planar', 'springmass']
    propor = args.propor
    ...
    dataset = datasets[env_name]('/Users/avi/Desktop/Food_GVAE-master/E2C_spring_mass/data/' )
...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_iter', default=500, type=int, help='the number of epoches')
    parser.add_argument('--iter_save', default=1000, type=int, help='save model and result after this number of iterations')
    parser.add_argument('--log_dir',default='/Users/avi/Desktop/Food_GVAE-master/E2C_spring_mass/logs', type=str, help='the directory to save training log')
